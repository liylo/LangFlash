...
from .dpt_gs_lang_head import create_gs_dpt_lang_head
from .scratch import create_scratch_head
...
def head_factory(head_type, output_mode, net, has_conf=False, out_nchan=3):
    ...
    elif head_type == 'dpt_gs_lang' and output_mode == 'gs_params':
        return create_gs_dpt_lang_head(net, has_conf=False, out_nchan=out_nchan, postprocess_func=None)
    elif head_type == 'scratch':
        return create_scratch_head(net, has_conf=False, out_nchan=out_nchan, postprocess_func=None)
    else:
