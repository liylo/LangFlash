...
#     gaussian_lang_weight: Float[Tensor, "batch gaussian num"] | None = None,
# ):
#     assert use_sh or gaussian_sh_coefficients.shape[-1] == 1
    
#     # if gaussian_lang_weight is None:
#     #     gaussian_lang_weight = torch.zeros((gaussian_means.shape[0],gaussian_means.shape[1],64)).to(gaussian_means.device)
...
#     all_radii = []
#     all_depths = []
#     all_language_feature_weight_map = []
#     for i in range(b):
...
#         language_feature_weights = gaussian_lang_weight[i]
#         image,language_feature_weight_map, radii = rasterizer(
...
#         all_language_feature_weight_map.append(language_feature_weight_map)
#         # all_depths.append(depth.squeeze(0))
#     # return torch.stack(all_images), torch.stack(all_depths)
#     # TODO
#     all_depths = None
#     # return torch.stack(all_images), all_depths, None
#     return torch.stack(all_images), all_depths, torch.stack(all_language_feature_weight_map)
